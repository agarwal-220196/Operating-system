...
int main() {
    ...
    Console::puts("Number of frames being requested: "); Console::puti(TEST_FRAME_SIZE);Console::puts("\n");

    unsigned long hole_pool_info_frame = process_mem_pool.get_frames(TEST_FRAME_SIZE);
